  ...
  return (
    <div className="App">
      ...
      <header>
        ...
        <br /><br />
        Firstly, you need to build up enough signatures depending on what your threshold was using the "Sign" tab. 
        <br /><br />
     ...
     <Dapp />
      ...
      <footer>
        ...
        <br />
        It takes inspiration from the <a href="https://motherfuckingwebsite.com/" target="_blank">Mother Fucking Website</a> and my laziness. Didn't the website load super fast? Nice, right? It's also primarily a developer tool. If you're not sure you can trust it, <a href="https://github.com/devanonon/binance-gnosis-recover">verify the source code.</a> Also, feel free to make a nicer UI ¯\_(ツ)_/¯.
        <br /><br />
        <p className="bold">Why build it?</p>
        <br />
        We had this issue at <a href="https://chainstride.capital/">Chainstride Capital</a> and needed a simple tool to retreive some vested tokens from our old BSC multisig. I thought I'd polish it (slightly) and share it with the world.
        <br /><br />
